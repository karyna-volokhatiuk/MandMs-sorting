// ======================================================================
// MandMs-sorting.v generated from TopDesign.cysch
// 11/13/2021 at 06:00
...
// TCPWM_P4_v2_10(Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, PinVisibility_index=false, PinVisibility_kill=false, PinVisibility_phiA=false, PinVisibility_phiB=false, PinVisibility_switch=false, PWMCompare=0, PWMCompareBuf=65535, PWMCompareSwap=0, PWMCountMode=3, PWMCountPresent=false, PWMDeadTimeCycle=0, PWMInterruptMask=1, PWMKillEvent=0, PWMLinenSignal=0, PWMLineSignal=0, PWMMode=4, PWMPeriod=255, PWMPeriodBuf=65535, PWMPeriodSwap=0, PWMPrescaler=0, PWMReloadMode=0, PWMReloadPresent=false, PWMRunMode=0, PWMSetAlign=0, PWMStartMode=0, PWMStartPresent=false, PWMStopEvent=0, PWMStopMode=0, PWMStopPresent=false, PWMSwitchMode=0, PWMSwitchPresent=false, QuadAutoStart=true, QuadEncodingModes=0, QuadIndexMode=0, QuadIndexPresent=false, QuadInterruptMask=1, QuadPhiAMode=3, QuadPhiBMode=3, QuadStopMode=0, QuadStopPresent=false, TCCaptureMode=0, TCCapturePresent=false, TCCompare=65535, TCCompareBuf=65535, TCCompareSwap=0, TCCompCapMode=2, TCCountingModes=0, TCCountMode=3, TCCountPresent=false, TCInterruptMask=1, TCPeriod=65535, TCPrescaler=0, TCPWMCapturePresent=false, TCPWMConfig=7, TCPWMCountPresent=false, TCPWMReloadPresent=false, TCPWMStartPresent=false, TCPWMStopPresent=false, TCReloadMode=0, TCReloadPresent=false, TCRunMode=0, TCStartMode=0, TCStartPresent=false, TCStopMode=0, TCStopPresent=false, TermMode_capture=0, TermMode_cc=0, TermMode_clock=0, TermMode_count=0, TermMode_interrupt=0, TermMode_line=0, TermMode_line_n=0, TermMode_ov=0, TermMode_reload=0, TermMode_start=0, TermMode_stop=0, TermMode_un=0, TermModeStates=, TermVisibility_capture=false, TermVisibility_cc=true, TermVisibility_clock=true, TermVisibility_count=false, TermVisibility_interrupt=true, TermVisibility_line=true, TermVisibility_line_n=true, TermVisibility_ov=true, TermVisibility_reload=false, TermVisibility_start=false, TermVisibility_stop=false, TermVisibility_un=true, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMMENT=, CY_COMPONENT_NAME=TCPWM_P4_v2_10, CY_CONFIG_TITLE=PWM_RED, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PWM_RED, CY_INSTANCE_SHORT_NAME=PWM_RED, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=PWM_RED, )
...
module top ;
    ...
    assign Net_1769 = Net_1759 & Net_1761[0];
    ...
    assign Net_1770 = Net_1758 & Net_1761[0];
	...
	wire [0:0] tmpOE__Step_2_5_net;
	wire [0:0] tmpFB_0__Step_2_5_net;
	wire [0:0] tmpIO_0__Step_2_5_net;
	wire [0:0] tmpINTERRUPT_0__Step_2_5_net;
	electrical [0:0] tmpSIOVREF__Step_2_5_net;

	cy_psoc3_pins_v1_10
		#(.id("bed3abe7-53d6-43e9-a22d-ccec343517b8"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Step_2_5
		 (.oe(tmpOE__Step_2_5_net),
		  .y({Net_1770}),
		  .fb({tmpFB_0__Step_2_5_net[0:0]}),
		  .io({tmpIO_0__Step_2_5_net[0:0]}),
		  .siovref(tmpSIOVREF__Step_2_5_net),
		  .interrupt({tmpINTERRUPT_0__Step_2_5_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Step_2_5_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Step_3_4_net;
	wire [0:0] tmpFB_0__Step_3_4_net;
	wire [0:0] tmpIO_0__Step_3_4_net;
	wire [0:0] tmpINTERRUPT_0__Step_3_4_net;
	electrical [0:0] tmpSIOVREF__Step_3_4_net;

	cy_psoc3_pins_v1_10
		#(.id("3d1d776c-8240-4340-aa21-5bde635888e6"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Step_3_4
		 (.oe(tmpOE__Step_3_4_net),
		  .y({Net_1769}),
		  .fb({tmpFB_0__Step_3_4_net[0:0]}),
		  .io({tmpIO_0__Step_3_4_net[0:0]}),
		  .siovref(tmpSIOVREF__Step_3_4_net),
		  .interrupt({tmpINTERRUPT_0__Step_3_4_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Step_3_4_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Dir_1_net;
	wire [0:0] tmpFB_0__Dir_1_net;
	wire [0:0] tmpIO_0__Dir_1_net;
	wire [0:0] tmpINTERRUPT_0__Dir_1_net;
	electrical [0:0] tmpSIOVREF__Dir_1_net;

	cy_psoc3_pins_v1_10
		#(.id("d3729e10-ac96-4e5f-b749-655e6ca43396"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		Dir_1
		 (.oe(tmpOE__Dir_1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Dir_1_net[0:0]}),
		  .io({tmpIO_0__Dir_1_net[0:0]}),
		  .siovref(tmpSIOVREF__Dir_1_net),
		  .interrupt({tmpINTERRUPT_0__Dir_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Dir_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Dir_2_5_net;
	wire [0:0] tmpFB_0__Dir_2_5_net;
	wire [0:0] tmpIO_0__Dir_2_5_net;
	wire [0:0] tmpINTERRUPT_0__Dir_2_5_net;
	electrical [0:0] tmpSIOVREF__Dir_2_5_net;

	cy_psoc3_pins_v1_10
		#(.id("3d75c33d-16df-4503-90cd-2909d8849cf6"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Dir_2_5
		 (.oe(tmpOE__Dir_2_5_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Dir_2_5_net[0:0]}),
		  .io({tmpIO_0__Dir_2_5_net[0:0]}),
		  .siovref(tmpSIOVREF__Dir_2_5_net),
		  .interrupt({tmpINTERRUPT_0__Dir_2_5_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Dir_2_5_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Dir_3_4_net;
	wire [0:0] tmpFB_0__Dir_3_4_net;
	wire [0:0] tmpIO_0__Dir_3_4_net;
	wire [0:0] tmpINTERRUPT_0__Dir_3_4_net;
	electrical [0:0] tmpSIOVREF__Dir_3_4_net;

	cy_psoc3_pins_v1_10
		#(.id("911ee831-bbd2-412e-b7cf-8e2044b5fa56"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Dir_3_4
		 (.oe(tmpOE__Dir_3_4_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Dir_3_4_net[0:0]}),
		  .io({tmpIO_0__Dir_3_4_net[0:0]}),
		  .siovref(tmpSIOVREF__Dir_3_4_net),
		  .interrupt({tmpINTERRUPT_0__Dir_3_4_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Dir_3_4_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    // -- SRFF Start --
    reg  cy_srff_1;
    always @(posedge Net_1440)
    begin
        cy_srff_1 <= (Net_78 | Net_75) & ~Net_1761[4];
    end
    assign Net_75 = cy_srff_1;
    // -- SRFF End --


    assign Net_1771 = Net_1754 & Net_1761[0];
    ...
    TCPWM_P4_v2_10_0 PWM_Container (
        .capture(1'b0),
        .cc(Net_830),
        .clock(Net_1440),
        .count(1'b1),
    ...
    FreqDiv_v1_0 FreqDiv_1 (
        ...
        .en(1'b1),
        .reset(1'b0));
    defparam FreqDiv_1.Divider = 40;
    defparam FreqDiv_1.highPulse = 20;
    defparam FreqDiv_1.numBits = 6;

	wire [0:0] tmpOE__Dir_Container_net;
	wire [0:0] tmpFB_0__Dir_Container_net;
	wire [0:0] tmpIO_0__Dir_Container_net;
	wire [0:0] tmpINTERRUPT_0__Dir_Container_net;
	electrical [0:0] tmpSIOVREF__Dir_Container_net;

	cy_psoc3_pins_v1_10
		#(.id("d17b465e-5aa4-462f-942a-ce1f7569c670"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Dir_Container
		 (.oe(tmpOE__Dir_Container_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Dir_Container_net[0:0]}),
		  .io({tmpIO_0__Dir_Container_net[0:0]}),
		  .siovref(tmpSIOVREF__Dir_Container_net),
		  .interrupt({tmpINTERRUPT_0__Dir_Container_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Dir_Container_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Step_Container_net;
	wire [0:0] tmpFB_0__Step_Container_net;
	wire [0:0] tmpIO_0__Step_Container_net;
	wire [0:0] tmpINTERRUPT_0__Step_Container_net;
	electrical [0:0] tmpSIOVREF__Step_Container_net;

	cy_psoc3_pins_v1_10
		#(.id("5303952b-a0ae-45d8-9877-3511481f9b42"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Step_Container
		 (.oe(tmpOE__Step_Container_net),
		  .y({Net_1458}),
		  .fb({tmpFB_0__Step_Container_net[0:0]}),
		  .io({tmpIO_0__Step_Container_net[0:0]}),
		  .siovref(tmpSIOVREF__Step_Container_net),
		  .interrupt({tmpINTERRUPT_0__Step_Container_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Step_Container_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    FreqDiv_v1_0 FreqDiv_2 (
        ...
        .en(1'b1),
        .reset(1'b0));
    defparam FreqDiv_2.Divider = 10;
    defparam FreqDiv_2.highPulse = 5;
    defparam FreqDiv_2.numBits = 4;
	...
	cy_psoc3_pins_v1_10
		#(.id("06e5fa1d-cd9a-4624-b1d3-5d27ed31c8f3"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("73cd4fb7-b583-465f-a394-465a391f68cd"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("d1833667-a031-4175-adbb-8b06d687f174"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__SW_UpDown_net;
	wire [0:0] tmpFB_0__SW_UpDown_net;
	wire [0:0] tmpIO_0__SW_UpDown_net;
	wire [0:0] tmpINTERRUPT_0__SW_UpDown_net;
	electrical [0:0] tmpSIOVREF__SW_UpDown_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  ...
		  .input_buffer_sel(2'b00))
		SW_UpDown
		 (.oe(tmpOE__SW_UpDown_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__SW_UpDown_net[0:0]}),
		  .analog({Net_1733}),
		  .io({tmpIO_0__SW_UpDown_net[0:0]}),
		  .siovref(tmpSIOVREF__SW_UpDown_net),
		  .interrupt({tmpINTERRUPT_0__SW_UpDown_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SW_UpDown_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
