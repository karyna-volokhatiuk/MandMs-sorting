...
module NeoPixel_3 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("cb12d90f-29cf-448b-9b91-4f54b2053bdb/e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
...
module top ;
    ...
    assign Net_130 = Net_110 & Net_100[0];
    ...
    assign Net_131 = Net_107 & Net_100[0];
    ...
    begin
        cy_srff_1 <= (Net_78 | Net_75) & ~Net_100[4];
    end
    assign Net_75 = cy_srff_1;
    // -- SRFF End --


    assign Net_132 = Net_104 & Net_100[0];
