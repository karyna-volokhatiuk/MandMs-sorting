...
#define THRESHOLD 4
/*
int red_struct_min[3];
int red_struct_max[3];

int green_struct_min[3];
int green_struct_max[3];

int blue_struct_min[3];
int blue_struct_max[3];

int yellow_struct_min[3];
int yellow_struct_max[3];


int orange_struct_min[3];
int orange_struct_max[3];

int brown_struct_min[3];
int brown_struct_max[3];
*/
